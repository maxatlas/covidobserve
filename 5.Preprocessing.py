...
def main(path="4.Get Tweets/full_text", ner_folder="5.Get NER Entities", from_i=0, to_i=-1, save_per_tweets=100000):
...
if __name__ == '__main__':
	...
	save = int(argv[3]) if len(argv)>3 else 50000
	main(path="4.Get Tweets/full_text", from_i=i1, to_i=i2, save_per_tweets=save)